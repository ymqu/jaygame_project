     ...
     <div class="h2">
		<div class="mui-content">
			...
			<div class="mui-content-padded">
				<button id='reg' class="mui-btn mui-btn-block mui-btn-primary" @click="update()">update</button>
			</div>
			<div class="mui-content-padded">
				<p></p>
			</div>
...
export default {
    ...
    methods:{
        ...
        userProfile(){
            this.$http.get('http://23.254.203.100:9001/user/profile'
            //this.$http.get('http://localhost:9001/user/profile'
            ).then(result =>{
                if(result.body.code===20000){
                    this.data = result.body.data
                    this.username = this.data.username;
                    this.password = this.data.password;
                    this.password_confirm = this.data.password;
    ...
    update(){
            ...
            this.$http.post('http://23.254.203.100:9001/user/update',{
			//this.$http.post('http://localhost:9001/user/update',{
                ...
                if(result.body.code===20000){
					this.popmsg ="Personal Information Update Success!"
